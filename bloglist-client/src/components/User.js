                ...
                <div className="border-2 border-black shadow-2xl rounded-lg py-4">
                    ...
                    <div className="py-2 px-4">
                        <ul className="grid gap-2">
                            <h4 className="text-xl text-blue-700 font-bold">Added Blogs:</h4>
                            {user.blogs === undefined
                                ? null
                                : user.blogs.map((userblog, index) => (
                                      <div key={userblog.id} className="grid grid-cols-10 text-lg font-normal pt-2">
                                          <h5 className="col-span-1">{index + 1}.</h5>
                                          <li className="col-span-9">{userblog.title}</li>
                                      </div>
                                  ))}
                        </ul>
                    </div>
